        ...
        <div class="dropdown-menu dashboard-dropdown dropdown-menu-end mt-2 py-1">
            <a class="dropdown-item d-flex align-items-center" href="#">
                <svg class="dropdown-icon text-gray-400 me-2" fill="currentColor"
                    ...
                    <path fill-rule="evenodd"
                          d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-6-3a2 2 0 11-4 0 2 2 0 014 0zm2 8a5 5 0 00-4-5.47 2.916A5.985 5.986 0 0016a5.986 5.986 0 004.546-2.084A5 5 0 0010 11z"
                          clip-rule="evenodd"></path>
                </svg>
                My Profile
            </a>
            ...
            <a class="dropdown-item d-flex align-items-center" href="#">
                <svg class="dropdown-icon text-gray-400 me-2" fill="currentColor"
                     viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd"
                          d="M11.49 3.17c-.381-1.56-2.6-1.56-2.98 0a1.532 1.532 0 01-2.286 2.94c-.372-.836-.2.94 2.42 2.106 2.106 5.24.886 0 1.042-2.947 2.287-1.561.379-1.561 2.6 0 1.533.01 2.287-.947c1.372-.836 3.247-2.106 2.106 1.533 1.532 0 01-.947 2.287c-.561-.379 1.561-2.6-.978 1.532 1.533 0 01-.947 2.287c-.836 1.372-.734 2.942-2.106 2.106a1.533 1.532 0 01-.287-.947z"
                          clip-rule="evenodd"></path>
                </svg>
                Settings
            </a>
               ...
               onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                <svg class="dropdown-icon text-danger me-2" fill="none" stroke="currentColor"
                    ...
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                          d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1m-3 3v1"></path>
                </svg>
                Logout
            </a>
